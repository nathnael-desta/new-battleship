...
var CodeConsole = (function (_super) {
    ...
    function CodeConsole(options) {
        ...
        _this._cells = new observablevector_1.ObservableVector();
     ...
     */
    CodeConsole.prototype._initialize = function () {
        var _this = this;
     ...
     */
    CodeConsole.prototype._onKernelChanged = function (sender, kernel) {
        this.clear();
        this._initialize();
