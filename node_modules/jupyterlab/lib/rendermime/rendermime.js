...
var sanitizer_1 = require("../common/sanitizer");
...
var RenderMime = (function () {
    ...
    function RenderMime(options) {
        ...
        this._sanitizer = options.sanitizer || sanitizer_1.defaultSanitizer;
    ...
    RenderMime.prototype._handleError = function (model) {
        ...
        return new widget_1.RenderedText(options);
    };
    return RenderMime;
}());
...
(function (RenderMime) {
    ...
    var UrlResolver = (function () {
        ...
        UrlResolver.prototype.resolveUrl = function (url) {
            ...
            var path = this._session.path;
            var cwd = services_1.ContentsManager.dirname(path);
            path = services_1.ContentsManager.getAbsolutePath(url, cwd);
