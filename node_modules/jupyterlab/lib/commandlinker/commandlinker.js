 ...
 */
exports.ICommandLinker = new application_1.Token('jupyter.services.command-linker');
/**
...
var CommandLinker = (function () {
     ...
     */
    CommandLinker.prototype.populateVirtualNodeAttrs = function (attrs, command, args) {
        var argsValue = JSON.stringify(args);
