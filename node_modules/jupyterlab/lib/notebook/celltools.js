...
var observablejson_1 = require("../common/observablejson");
/**
 ...
 */
var SELECT_WRAPPER_CLASS = 'jp-KeySelector-selectWrapper';
/**
 ...
 * The main menu token.
 */
exports.ICellTools = new application_1.Token('jupyter.services.cell-tools');
;
/**
...
var CellTools = (function (_super) {
    ...
    CellTools.prototype._onMetadataChanged = function (sender, args) {
        var message = new observablejson_1.ObservableJSON.ChangeMessage(args);
        algorithm_1.each(this.children(), function (widget) {
...
(function (CellTools) {
    ...
    var ActiveCellTool = (function (_super) {
        ...
        ActiveCellTool.prototype.onActiveCellChanged = function () {
            ...
            var prompt = new widgets_2.Widget({ node: promptNode });
    ...
    var MetadataEditorTool = (function (_super) {
        ...
        function MetadataEditorTool(options) {
            ...
            _this.editor = new observablejson_1.ObservableJSONWidget({ editorFactory: editorFactory });
    ...
    var KeySelector = (function (_super) {
        ...
        KeySelector.prototype.handleEvent = function (event) {
            var wrapper = this.node.getElementsByClassName(SELECT_WRAPPER_CLASS)[0];
            switch (event.type) {
                case 'change':
                    this.onValueChanged();
                    break;
...
(function (Private) {
    ...
    function createSelectorNode(options) {
        ...
        return virtualdom_1.VirtualDOM.realize(virtualdom_1.h.div({}, virtualdom_1.h.label(title), virtualdom_1.h.div({ className: SELECT_WRAPPER_CLASS }, virtualdom_1.h.select({}, optionNodes))));
    }
    ...
    function createMetadataHeader() {
        ...
        return new widgets_2.Widget({ node: node });
    }
