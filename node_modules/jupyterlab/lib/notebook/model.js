...
var undoablevector_1 = require("../common/undoablevector");
/**
...
var NotebookModel = (function (_super) {
    ...
    function NotebookModel(options) {
        ...
        _this._cells = null;
        _this._nbformat = services_1.nbformat.MAJOR_VERSION;
        _this._nbformatMinor = services_1.nbformat.MINOR_VERSION;
        _this._metadata = new observablejson_1.ObservableJSON();
        var factory = (options.contentFactory || NotebookModel.defaultContentFactory);
        _this.contentFactory = factory;
        _this._cells = new undoablevector_1.ObservableUndoableVector(function (cell) {
            switch (cell.cell_type) {
                case 'code':
                    return factory.createCodeCell({ cell: cell });
                case 'markdown':
                    return factory.createMarkdownCell({ cell: cell });
                default:
                    return factory.createRawCell({ cell: cell });
            }
        });
    ...
    var ContentFactory = (function () {
        ...
        function ContentFactory(options) {
            this.codeCellContentFactory = (options.codeCellContentFactory ||
                model_1.CodeCellModel.defaultContentFactory);
        }
        /**
        ...
        ContentFactory.prototype.createCodeCell = function (options) {
            ...
            return new model_1.CodeCellModel(options);
        };
        /**
        ...
        ContentFactory.prototype.createMarkdownCell = function (options) {
            return new model_1.MarkdownCellModel(options);
        };
        /**
        ...
        ContentFactory.prototype.createRawCell = function (options) {
            return new model_1.RawCellModel(options);
        };
