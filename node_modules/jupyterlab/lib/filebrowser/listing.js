...
var DirListing = (function (_super) {
    ...
    function DirListing(options) {
        ...
        var headerNode = utils.findElement(_this.node, HEADER_CLASS);
    ...
    DirListing.prototype.delete = function () {
        ...
        if (names.length) {
            return dialog_1.showDialog({
                ...
                if (!_this.isDisposed && result.text === 'DELETE') {
    ...
    DirListing.prototype._onActivateRequested = function (sender, args) {
        var dirname = services_1.ContentsManager.dirname(args);
        if (dirname === '.') {
            dirname = '';
        }
        ...
        var basename = services_1.ContentsManager.basename(args);
