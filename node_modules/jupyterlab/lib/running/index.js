...
var RunningSessions = (function (_super) {
    ...
    function RunningSessions(options) {
        ...
        if (manager.terminals.isAvailable()) {
            var termNode = dom_1.findElement(_this.node, TERMINALS_CLASS);
        ...
        var sessionNode = dom_1.findElement(_this.node, SESSIONS_CLASS);
    ...
    RunningSessions.prototype.onUpdateRequest = function (msg) {
        ...
        var termSection = dom_1.findElement(this.node, TERMINALS_CLASS);
        var termList = dom_1.findElement(termSection, LIST_CLASS);
        var sessionSection = dom_1.findElement(this.node, SESSIONS_CLASS);
        var sessionList = dom_1.findElement(sessionSection, LIST_CLASS);
    ...
    RunningSessions.prototype._evtClick = function (event) {
        ...
        var sessionSection = dom_1.findElement(this.node, SESSIONS_CLASS);
        var sessionList = dom_1.findElement(sessionSection, LIST_CLASS);
        var refresh = dom_1.findElement(this.node, REFRESH_CLASS);
        var renderer = this._renderer;
        ...
        var index = dom_1.hitTestNodes(termList.children, clientX, clientY);
        if (index !== -1) {
        ...
        index = dom_1.hitTestNodes(sessionList.children, clientX, clientY);
        if (index !== -1) {
...
(function (RunningSessions) {
    ...
    var Renderer = (function () {
        ...
        Renderer.prototype.getTerminalShutdown = function (node) {
            return dom_1.findElement(node, SHUTDOWN_BUTTON_CLASS);
        };
        /**
        ...
        Renderer.prototype.updateTerminalNode = function (node, model) {
            var label = dom_1.findElement(node, ITEM_LABEL_CLASS);
        ...
        Renderer.prototype.updateSessionNode = function (node, model, kernelName) {
            var icon = dom_1.findElement(node, ITEM_ICON_CLASS);
