...
var OutputAreaWidget = (function (_super) {
    ...
    function OutputAreaWidget(options) {
        ...
        model.changed.connect(_this._onModelChanged, _this);
        return _this;
    }
    /**
     ...
     */
    OutputAreaWidget.prototype.execute = function (code, kernel) {
        var _this = this;
        ...
        return new Promise(function (resolve, reject) {
            ...
            future.onStdin = function (msg) {
                if (services_1.KernelMessage.isInputRequestMsg(msg)) {
                    _this._onInputRequest(msg, kernel);
                }
            };
        });
    };
     ...
     */
    OutputAreaWidget.prototype._onInputRequest = function (msg, kernel) {
     ...
     */
    OutputAreaWidget.prototype._onModelChanged = function (sender, args) {
        switch (args.type) {
            case 'add':
