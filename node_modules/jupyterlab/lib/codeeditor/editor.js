...
var observablestring_1 = require("../common/observablestring");
var observablemap_1 = require("../common/observablemap");
/**
...
(function (CodeEditor) {
    ...
    var Model = (function () {
        ...
        function Model(options) {
            this._selections = new observablemap_1.ObservableMap();
            this._isDisposed = false;
            this._mimeTypeChanged = new signaling_1.Signal(this);
            options = options || {};
            this._value = new observablestring_1.ObservableString(options.value);
