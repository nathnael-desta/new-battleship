 ...
 * The launcher token.
 */
exports.ILauncher = new application_1.Token('jupyter.services.launcher');
/* tslint:enable */
/**
...
var LauncherWidget = (function (_super) {
    ...
    LauncherWidget.prototype.render = function () {
        ...
        var children = algorithm_1.map(this.model.items(), function (item) {
            ...
            var attrs = _this._linker.populateVirtualNodeAttrs({
                className: ITEM_CLASS
            }, item.command, item.args);
            return virtualdom_1.h.div(attrs, [img, text]);
        });
