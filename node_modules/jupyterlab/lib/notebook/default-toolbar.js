...
(function (ToolbarItems) {
    ...
    function createInsertButton(panel) {
        return new toolbar_1.ToolbarButton({
            ...
            onClick: function () { actions_1.NotebookActions.insertBelow(panel.notebook); },
    ...
    function createCutButton(panel) {
        return new toolbar_1.ToolbarButton({
            ...
            onClick: function () {
                actions_1.NotebookActions.cut(panel.notebook, panel.clipboard);
            },
    ...
    function createCopyButton(panel) {
        return new toolbar_1.ToolbarButton({
            ...
            onClick: function () {
                actions_1.NotebookActions.copy(panel.notebook, panel.clipboard);
            },
    ...
    function createPasteButton(panel) {
        return new toolbar_1.ToolbarButton({
            ...
            onClick: function () {
                actions_1.NotebookActions.paste(panel.notebook, panel.clipboard);
            },
    ...
    function createRunButton(panel) {
        return new toolbar_1.ToolbarButton({
            ...
            onClick: function () {
                actions_1.NotebookActions.runAndAdvance(panel.notebook, panel.kernel);
            },
...
var CellTypeSwitcher = (function (_super) {
    ...
    function CellTypeSwitcher(widget) {
        ...
        var select = _this._select = _this.node.firstChild;
